...
* *Minor enhancement*: added *View Duplicate tasks command*
** What it does:
. Allows user to view all duplicate tasks in their list
** Justification:
...
.. View duplicates +
include::../UserGuide.adoc[tag=viewDuplicates]
.. Filter +
...
=== Team-based Tasks
. Refactored all occurrences of Study Buddy to Study Buddy. Link to PR https://github.com/AY1920S2-CS2103T-W16-3/main/pull/135[Refactor]
