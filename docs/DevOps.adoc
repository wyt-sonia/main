...
. Update the version number in link:{repoURL}/src/main/java/draganddrop/address/MainApp.java[`MainApp.java`].
...
For example, Study Buddy depends on the https://github.com/FasterXML/jackson[Jackson library] for JSON parsing.
