...
|`* *` |user |view duplicate tasks | easily filter out any duplicate data in my list
...
[discrete]
=== Use case: View duplicates

*MSS*


1. User requests to view duplicates
2. Study Buddy shows a list of duplicates
+
Use case ends.
