...
=== Archive feature
Archive stores selected task away into a seperate task list, this command is used when the user has completed a task but still wants to keep track of it.
...
image::UMLmodule.jpeg[width = "800", length = "600"]
