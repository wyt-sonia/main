...
:repoURL: https://github.com/AY1920S2-CS2103T-W16-3/main/tree/master
...
(For all use cases below, the *System* is `IVLE` and the *Actor* is the `user`, unless specified otherwise)
...
2. IVLE shows a list of tasks
3. User requests to delete a specific task in the list
4. IVLE deletes the task
+
Use case ends.
...
+
[none]
** 3a1. IVLE shows an error message.
+
