...
`Main` has two classes called link:{repoURL}/src/main/java/draganddrop/address/Main.java[`Main`] and link:{repoURL}/src/main/java/draganddrop/address/MainApp.java[`MainApp`].
...
*API* : link:{repoURL}/src/main/java/draganddrop/address/ui/Ui.java[`Ui.java`]
...
For example, the layout of the link:{repoURL}/src/main/java/draganddrop/studybuddy/ui/MainWindow.java[`MainWindow`] is specified in link:{repoURL}/src/main/resources/view/MainWindow.fxml[`MainWindow.fxml`]
...
*API* :
link:{repoURL}/src/main/java/draganddrop/address/logic/Logic.java[`Logic.java`]
...
*API* : link:{repoURL}/src/main/java/draganddrop/address/model/Model.java[`Model.java`]
...
*API* : link:{repoURL}/src/main/java/draganddrop/address/storage/Storage.java[`Storage.java`]
...
image::DueSoonActivityDiagram.png[width = "400", length = "600", title = "Activity diagram for refresh"]


image::DueSoonSequenceDiagram.png[width = "600", length = "500", title = "Sequence diagram for refresh"]
