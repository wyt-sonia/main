...
past day, week and more on the Productivity page.
The Productivity Page can be viewed by clicking on the Productivity menu item or
clicking on the Productivity Points shown live on the top right of the application window.

The productivity feature is facilitated by `Statistics`, which allows
...
Clicking on the  menu item will enable this feature.
