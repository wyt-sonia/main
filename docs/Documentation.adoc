...
|`site-draganddrop`
|Define this attribute if the project is an official draganddrop project.
This will render the draganddrop navigation bar at the top of the page, and add some draganddrop-specific navigation items.
|_not set_
