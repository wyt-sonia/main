...
image::dashboard/dashboard_1 5.png[title = "Access your other things here!"]

The left side features your entire list of tasks to complete.

image::dashboard/dashboard_1 2.png[title = "All task to complete"]

The right side displays your tasks that are to be due soon

image::dashboard/dashboard_1 3.png[title = "Task due soon"]

The bottom is your input line. You can type your commands to tell Study Buddy what to do and he will reply
you!

image::dashboard/dashboard_1 4.png[title = "Chat with Studdy Buddy here!"]
...
image::basic/done/done_1.png[title = "Presentation to be marked as finished"]

Now key in the index of the task you wish to complete.

image::basic/done/done_2.png[title = "Press `Enter` to confirm changes"]

Press `Enter` again to confirm your change.

image::basic/done/done_3.png[title = "Presentation 1 is marked as finished"]
...
image::module/module_7.png[title = "click on `Create`"]
