...
:repoURL: https://github.com/AY1920S2-CS2103T-W16-3/main.git

By: `Team Drag&Drop`      Since: `Jan 2020`

== Introduction

IVLE is for an application designed for those who *prefer to use a desktop app for managing module related tasks*. More importantly, IVLE is *optimized for those who prefer to work with a Command Line Interface* (CLI) while still having the benefits of a Graphical User Interface (GUI). If you can type fast, IVLE can get your module management done faster than traditional GUI apps. Interested? Jump to the <<Quick Start>> to get started. Enjoy!
