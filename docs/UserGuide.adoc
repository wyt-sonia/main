...
. Study Buddy should respond with:
+
image::duplicate/addDuplicate.png[width="600", title="Reponse to adding a duplicate"]
+
...
+
image::duplicate/addDuplicate1.png[width="600", title="Response to adding duplicate"]
+
...
+
image::duplicate/addDuplicate2.png[width="600", title="Response to choosing not to add"]
...
. Study Buddy should respond with:
+
image::basic/viewrenamed/viewRenamed1.png[width="600", title="Response to 'view renamed'"]

. Press kbd:[enter] again to confirm
. Renamed tasks have been filtered!
+
image::basic/viewrenamed/viewRenamed2.png[width="600", title="Updated list of renamed tasks"]
...
image::calendar/calendar_init.png[width="600", align= "left", title="calendar interface"]
...
image::calendar/calendar_click.png[width="600"", align="left", title="calendar after clicking on a date"]
...
+
image::calendar/Calendar_CLI_Date.png[width="600", align="left", title="Interactive prompt after keying in calendar"]
+
...
image::calendar/calendar_after_CLI.png[width="600", align="left", title="Successfully navigated calendar using CLI"]
