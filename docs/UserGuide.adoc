...
. Study Buddy should respond with:
+
image::clear/clear1.png[width="790", title="Response to 'clear'"]
+
[NOTE]
...
+
image::clear/clear2.png[width="790", title="View empty Study Buddy"]
...
image::module/Module-bar.png[title = "`Modules` in the menu bar"]
...
image::module/Module-bar-2.png[]


Then click on `Show Modules`. The module page should show up.

image::module/Modules-page.png[]
