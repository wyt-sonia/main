...
`Time left for deadline` and  `Task Type` of each tasks in *Tasks Due Soon Panel* , we use *Badges*.

Weight & Module Code::
* All in steelblue.
* It displays the weight and module code of a task.

Time left for deadline::
* All in light orange.
* It displays the time left for a tasks' deadline.
