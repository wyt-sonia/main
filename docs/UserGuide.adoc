...
.. All tasks
+
Contains a list of all your unarchived tasks on the left panel and a list of your tasks that are due soon on the right panel.
+
.. Archived tasks
+
Contains a list of all your archived tasks on the left panel and due soon tasks on the right panel.
+
.. Exit
+
Short-cut exit the application.
+
. *Modules*
+
.. Show
Contains all your modules in separate tabs and their respective tasks.
+
.. Create
Short-cut to create modules.
+
.. Edit
Short-cut to edit modules.
+
. *Statistics*
+
.. Task Status
Contains a summary of tasks' status.
+
.. Module related Tasks' Deadline/Start Date
Contains a summary of module related tasks' deadline and start date.
+
.. Module related Task Weight
Contains a summary of module related task weights.
+
. *Calendar*
Contains a calender view and a panel to display tasks on the day you choose.
+
. *Productivity*
+
.. Daily
