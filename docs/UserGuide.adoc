...
* *SB* and *You* refers to *Study Buddy* and the *User* respectively.
* When a line is preceded by *SB*, it implies that it is a *reply displayed by Study Buddy*.
* When a line is preceded by *You*, it implies that it is a value that must be *entered by the user*.
...
*SB -* asks for sorting term and provides the list of available sorting terms

*You-* `INDEX NUMBER OF SORTING TERM`

*SB -* asks for your confirmation

*You-* `[enter]`

*SB -* Task sorted successfully!
...
*SB -* Please choose the sort keyword: +
...
*SB -* The task  will be sorted by Deadline / Task Start Date. +
...
*SB -* Please type in a keyword that you want to search for.

*You-* `quiz`

*SB -* Returns `Weekly Quiz` and `Quiz 3`
****
[NOTE]
...
*SB -* Here is the complete list of tasks:
****
==== Refresh
