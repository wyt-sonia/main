...
public class CompleteTaskInteractivePrompt extends InteractivePrompt {
    ...
    private static final String QUIT_COMMAND_MSG = "Successfully quited from complete task command.";
    private static final String REQUEST_INDEX_MSG = "Please enter the index number of task you wish to mark as finished.";
