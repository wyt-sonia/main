...
public class DeleteDuplicateTaskInteractivePrompt extends InteractivePrompt {
    final public static String QUIT_COMMAND_MSG = "Successfully quited from delete duplication command.";
    final private static String END_OF_COMMAND_MSG = "Duplicated task deleted successfully!";
