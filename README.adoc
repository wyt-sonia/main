...
https://travis-ci.org/se-edu/addressbook-level3[image:https://travis-ci.org/teikjun/main.svg?branch=master[Build Status]]
...
* <Project Name> is a  task keeper for students who wish to manage their time more efficiently.
* With the help of <Project Name>, students can easily manage and view their school tasks.
...
==== Who can benefit most from <Project Name>?
